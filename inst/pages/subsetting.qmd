...
#Inspect library sizes among samples:
summary(colSums(assay(tse, "counts")))
...
Then we can calculate the total number of counts in each sample in this subsetted data.
